...
import { ChainId, JSBI, Percent, Token, WETH } from '@backy22/u-exchange-sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'

import { fortmatic, injected, portis, walletconnect, walletlink } from '../connectors'

export const ROUTER_ADDRESS = '0x0b5fdf0C4afd3dc5EBE030c6C0EBa4784697eFEA'
...
export const UCASH: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.RINKEBY]: new Token(
    ChainId.RINKEBY,
    '0xeB0De4e9A7a89C4747597FDCBe1ec0a38a99eE89',
    18,
    'UCASH',
    'Universal Cash'
  ),
  ...
  [ChainId.BINANCE]: new Token(
    ChainId.BINANCE,
    '0xb2535bc0cb30273b7b109eda98b348d4f4634e05',
    8,
    'UCASH',
    'Universal Cash'
  ),
